...
#define SPICLOCK_TRIS            TRISGbits.TRISG6
// Description: The TRIS bit for the SDI pin
#define SPIIN_TRIS               TRISGbits.TRISG7
// Description: The TRIS bit for the SDO pin
#define SPIOUT_TRIS              TRISGbits.TRISG8
...
void MDD_SDSPI_InitIO (void)
{
    ...
    SPICLOCK_TRIS = 0;
    SPIOUT_TRIS = 0;                  // define SDO1 as output (master or slave)
    SPIIN_TRIS = 1;                  // define SDI1 as input (master or slave)
}
