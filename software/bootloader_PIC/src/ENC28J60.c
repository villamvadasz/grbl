...
void MACInit(void)
{
	...
	RPC13Rbits.RPC13R = 0b1000; //SDO	RC13
	SDI1Rbits.SDI1R = 0b0011;   //SDI	RD11
#endif
...
BOOL MACIsLinked(void) {return 0;}

BOOL MACGetHeader(MAC_ADDR *remote, BYTE* type) {return 0;}
void MACSetReadPtrInRx(WORD offset) {}
PTR_BASE MACSetWritePtr(PTR_BASE address) {return 0;}
PTR_BASE MACSetReadPtr(PTR_BASE address) {return 0;}
BYTE MACGet(void) {return 0;}
WORD MACGetArray(BYTE *val, WORD len) {return 0;}
void MACDiscardRx(void) {}
WORD MACGetFreeRxSize(void) {return 0;}
void MACMemCopyAsync(PTR_BASE destAddr, PTR_BASE sourceAddr, WORD len) {}
BOOL MACIsMemCopyDone(void) {return 0;}

void MACPutHeader(MAC_ADDR *remote, BYTE type, WORD dataLen) {}
BOOL MACIsTxReady(void) {return 0;}
void MACPut(BYTE val) {}
void MACPutArray(BYTE *val, WORD len) {}
void MACFlush(void) {}
