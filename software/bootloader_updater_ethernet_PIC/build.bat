...
:makecall_external
del /q .\output\EthernetBootloader_updater_%CPU_TARGET%.hex
...
copy .\output\EthernetBootloader_updater.hex .\output\EthernetBootloader_updater_%CPU_TARGET%_Q%XTAL_TARGET%_F%SYS_TARGET%.hex
copy .\output\EthernetBootloader_updater.map .\output\EthernetBootloader_updater_%CPU_TARGET%_Q%XTAL_TARGET%_F%SYS_TARGET%.map
.\make\make.exe -f Makefile_%CPU_TARGET% clean
del /q .\output\EthernetBootloader_updater.map
del /q .\output\EthernetBootloader_updater.map
goto :eof
...
copy .\output\EthernetBootloader_updater.hex .\output\EthernetBootloader_updater_%CPU_TARGET%_RCINT8_F%SYS_TARGET%.hex
copy .\output\EthernetBootloader_updater.map .\output\EthernetBootloader_updater_%CPU_TARGET%_RCINT8_F%SYS_TARGET%.map
.\make\make.exe -f Makefile_%CPU_TARGET% clean
del /q .\output\EthernetBootloader_updater.map
del /q .\output\EthernetBootloader_updater.map
goto :eof
