...
const INT_SCR_TBL_ENTRY __IntSrcTbl[] =
{
    ...
    {   &IFS0,  &IEC0,  _IFS0_OC1IF_MASK       },  // Output Compare 1
    {   &IFS0,  &IEC0,  _IFS0_OC2IF_MASK       },  // Output Compare 2
    {   &IFS0,  &IEC0,  _IFS0_OC3IF_MASK       },  // Output Compare 3
    {   &IFS0,  &IEC0,  _IFS0_OC4IF_MASK       },  // Output Compare 4
    {   &IFS0,  &IEC0,  _IFS0_OC5IF_MASK       },  // Output Compare 5
    ...
    {   &IFS1,  &IEC1,  _IFS1_CNDIF_MASK       },  // Input Change,Port D
    {   &IFS1,  &IEC1,  _IFS1_CNEIF_MASK       },  // Input Change,Port E
    {   &IFS1,  &IEC1,  _IFS1_CNFIF_MASK       },  // Input Change,Port F
    {   &IFS1,  &IEC1,  _IFS1_CNGIF_MASK       },  // Input Change,Port G
    ...
    {   &IFS2,  &IEC2,  (_IFS2_SPI3EIF_MASK | _IFS2_SPI3TXIF_MASK | _IFS2_SPI3RXIF_MASK) }, //SPI3
  #if defined( _SPI4 )
    {   &IFS2,  &IEC2,  (_IFS2_SPI4EIF_MASK | _IFS2_SPI4TXIF_MASK | _IFS2_SPI4RXIF_MASK) }, //SPI4
  #else
    {   (VUINT *)0, (VUINT *)0,   0             },
  #endif
    ...
    {   &IFS2,  &IEC2,  _IFS2_SPI3EIF_MASK     },  // SPI 3 Error
  #if defined( _SPI4 )
    {   &IFS2,  &IEC2,  _IFS2_SPI4EIF_MASK     },  // SPI 4 Error
  #else
    {   (VUINT *)0, (VUINT *)0,   0             },
  #endif
    ...
    {   &IFS2,  &IEC2,  _IFS2_SPI3TXIF_MASK    },  // SPI 3 Transmit Done
  #if defined( _SPI4 )
    {   &IFS2,  &IEC2,  _IFS2_SPI4TXIF_MASK    },  // SPI 4 Transmit Done
  #else
    {   (VUINT *)0, (VUINT *)0,   0             },
  #endif
    ...
    {   &IFS2,  &IEC2,  _IFS2_SPI3RXIF_MASK    },  // SPI 3 Receive  Done
  #if defined( _SPI4 )
    {   &IFS2,  &IEC2,  _IFS2_SPI4RXIF_MASK    },  // SPI 4 Receive  Done
  #else
    {   (VUINT *)0, (VUINT *)0,   0             },
  #endif
  ...
  #if defined( _UART5 )
    {   &IFS2,  &IEC2,  (_IFS2_U5EIF_MASK | _IFS2_U5RXIF_MASK | _IFS2_U5TXIF_MASK)}, //UART5
  #else
    {   (VUINT *)0, (VUINT *)0,   0                                               },
  #endif
  ...
  #if defined( _UART5 )
    {   &IFS2,  &IEC2,  _IFS2_U5RXIF_MASK      },  // UART 5 Receive
  #else
    {   (VUINT *)0, (VUINT *)0,   0                                               },
  #endif
  ...
  #if defined( _UART5 )
    {   &IFS2,  &IEC2,  _IFS2_U5TXIF_MASK      },  // UART 5 Transmit
  #else
    {   (VUINT *)0, (VUINT *)0,   0                                               },
  #endif
    ...
    {   &IFS2,  &IEC2,  _IFS2_CMP3IF_MASK      },  // Comparator 3 Interrupt
...
#   ifdef _CAN1
    {   &IFS2,  &IEC2,  _IFS2_CAN1IF_MASK       },  // USB
#   else
    {   (VUINT *)0, (VUINT *)0,   0      },
#   endif
