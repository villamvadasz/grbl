...
static DWORD startTick = 1000;
volatile unsigned int do_berkeleyapi_1ms = 0;

void init_berkeleyapi(void) {
}

void do_berkeleyapi(void) {
	if (do_berkeleyapi_1ms) {
		do_berkeleyapi_1ms = 0;
		{
			if (startTick != 0) {
				startTick--;
			}
...
void isr_berkeleyapi_1ms(void) {
	do_berkeleyapi_1ms = 1;
}

void deinit_berkeleyapi(void) {
}
