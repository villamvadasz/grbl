...
#define _CPU_MAP_CNC_1_0_0_SIMULATOR_H_
		...
		#define STEP_X_DDR dummyTRIS7
		#define STEP_Y_DDR dummyTRIS6
		#define STEP_Z_DDR dummyTRIS5
		#define STEP_X_PORT dummyLAT7
		#define STEP_Y_PORT dummyLAT6
		#define STEP_Z_PORT dummyLAT5

		#define DIRECTION_X_DDR dummyTRIS4
		#define DIRECTION_Y_DDR dummyTRIS3
		#define DIRECTION_Z_DDR dummyTRIS2
		#define DIRECTION_X_PORT dummyLAT4
		#define DIRECTION_Y_PORT dummyLAT3
		#define DIRECTION_Z_PORT dummyLAT2

		#define STEPPERS_DISABLE_DDR dummyTRIS1
		#define STEPPERS_DISABLE_PORT dummyLAT1
