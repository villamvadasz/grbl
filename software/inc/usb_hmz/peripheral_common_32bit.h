...
static __inline__ uintptr_t __attribute__ ( ( always_inline ) ) _PLIB_VirtToPhys ( const void* p )
{
...
static __inline__ void* __attribute__ ( ( always_inline ) ) _PLIB_PhysToVirtK0 ( uintptr_t a )
{
...
static __inline__ void* __attribute__((always_inline)) _PLIB_PhysToVirtK1( uintptr_t a )
{
