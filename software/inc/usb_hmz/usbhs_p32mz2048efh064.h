...
PLIB_INLINE SFR_TYPE* _USBHS_USB_ID_OVERWRITE_CONTROL_VREG(USBHS_MODULE_ID i)
{
    switch (i) {
        case USBHS_ID_0 :
            return &USBCRCON;
...
PLIB_INLINE SFR_TYPE* _USBHS_PHY_ID_MONITORING_CONTROL_VREG(USBHS_MODULE_ID i)
{
    switch (i) {
        case USBHS_ID_0 :
            return &USBCRCON;
...
PLIB_INLINE SFR_DATA _USBHS_USB_ID_OVERWRITE_CONTROL_MASK(USBHS_MODULE_ID i)
{
    switch (i) {
        case USBHS_ID_0 :
            return _USBCRCON_USBIDOVEN_MASK;
        case USBHS_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _USBHS_PHY_ID_MONITORING_CONTROL_MASK(USBHS_MODULE_ID i)
{
    switch (i) {
        case USBHS_ID_0 :
            return _USBCRCON_PHYIDEN_MASK;
        case USBHS_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _USBHS_CLOCK_RESET_USB_INTERRUPT_ENABLE_MASK(USBHS_MODULE_ID i)
{
    switch (i) {
        case USBHS_ID_0 :
            return _USBCRCON_USBIE_MASK;
        case USBHS_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _USBHS_USB_ID_OVERWRITE_CONTROL_POS(USBHS_MODULE_ID i)
{
    switch (i) {
        case USBHS_ID_0 :
            return _USBCRCON_USBIDOVEN_POSITION;
        case USBHS_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _USBHS_PHY_ID_MONITORING_CONTROL_POS(USBHS_MODULE_ID i)
{
    switch (i) {
        case USBHS_ID_0 :
            return _USBCRCON_PHYIDEN_POSITION;
        case USBHS_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _USBHS_CLOCK_RESET_USB_INTERRUPT_ENABLE_POS(USBHS_MODULE_ID i)
{
    switch (i) {
        case USBHS_ID_0 :
            return _USBCRCON_USBIE_POSITION;
        case USBHS_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _USBHS_USB_ID_OVERWRITE_CONTROL_LEN(USBHS_MODULE_ID i)
{
    switch (i) {
        case USBHS_ID_0 :
            return _USBCRCON_USBIDOVEN_LENGTH;
        case USBHS_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _USBHS_PHY_ID_MONITORING_CONTROL_LEN(USBHS_MODULE_ID i)
{
    switch (i) {
        case USBHS_ID_0 :
            return _USBCRCON_PHYIDEN_LENGTH;
        case USBHS_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _USBHS_CLOCK_RESET_USB_INTERRUPT_ENABLE_LEN(USBHS_MODULE_ID i)
{
    switch (i) {
        case USBHS_ID_0 :
            return _USBCRCON_USBIE_LENGTH;
        case USBHS_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
#include "usbhs_EndpointFIFO_Default.h"
#include "usbhs_SoftReset_Default.h"
#include "usbhs_Interrupts_Default.h"
#include "usbhs_HighSpeedSupport_Default.h"
#include "usbhs_ClockResetControl_Default.h"
#include "usbhs_USBIDControl_Default.h"
#include "usbhs_ModuleControl_Default.h"
#include "usbhs_EP0Status_Default.h"
#include "usbhs_TxEPStatus_Default.h"
#include "usbhs_RxEPStatus_Default.h"
#include "usbhs_EndpointOperations_Default.h"
