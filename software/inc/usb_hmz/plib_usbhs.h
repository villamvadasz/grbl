...
/*
    ...
    For PIC32MZ EC devices, SFR field USBCSR3<29:28> = <FORCEFS:FORCEHS>.
*/
...
/* USBHS FIFO State Enumeration
  ...
  Description:
    This data type provides enumeration of receive and transmit FIFO states, as reported by
    status bits.
  ...
  For Transmit Endpoints:
    ...
    PIC32MZ EC device SFR fields: USBIENCSR0.FIFONE = USBIENCSR0<17>, with USBCSR3.ENDPOINT = 1,2,...7

  For Receive  Endpoints:
    MG register fields: RXCSRL.FIFOFull = RXCSRL<1>, with INDEX.SelectedEndpoint = 1,2,...7
    PIC32MZ EC device SFR fields: USBIENCSR1.FIFOFULL = USBIENCSR1<17>, with USBCSR3.ENDPOINT = 1,2,...7
*/
 typedef enum
{
...
/* USBHS Iso Packets Per Microframe Enumeration
  ...
  Description:
    This data type provides an enumeration of the allowable isochronous packets per microframe
    when operating in High-Speed mode.
  ...
  For Transmit Endpoints:
    PIC32MZ EC device SFR fields: USBIENCSR0.MULT<1:0> = USBIENCSR0<12:11>, with USBCSR3.ENDPOINT = 1,2,...7

  For Receive  Endpoints:
    MG register fields: RXMAXP.m-1 = RXMAXP<12:11>, with INDEX.SelectedEndpoint = 1,2,...7
    PIC32MZ EC device SFR fields: USBIENCSR1.MULT<1:0> = USBIENCSR1<12:11>, with USBCSR3.ENDPOINT = 1,2,...7
*/
...
/* Function:
  ...
  Parameters:
    ...
    hubPortAddress  - Port number of the hub port to which the device is
                      connected if it is connected to a hub. Should be zero otherwise.
...
/* Function:
  ...
  Description:
    This function enables RX endpoint interrupt sources of the USB module to trigger 
	a USB interrupt.
...
/* Function:
  ...
  Description:
    This function enables USB module event interrupts. Combines the functionality of
    the PLIB_USBHS_RxInterruptEnable, PLIB_USBHS_TxInterruptEnable, and
    PLIB_USBHS_GenInterruptEnable functions.
