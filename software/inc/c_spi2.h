...
#define _C_SPI2_H_
	...
	#define SPI2_SCK_TRIS	TRISGbits.TRISG8
	#define SPI2_SDI_TRIS	TRISGbits.TRISG7
	#define SPI2_SDO_TRIS	TRISGbits.TRISG8

	extern void SPI2_LOCK_COLLISION_CALLOUT(void);
	#define SPI2_LOCK_COLLISION_CALLOUT()		SPI2_LOCK_COLLISION_CALLOUT()
