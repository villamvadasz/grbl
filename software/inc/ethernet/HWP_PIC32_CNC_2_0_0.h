 ...
 ********************************************************************/
#ifndef _HWP_PIC32_CNC_2_0_0_H_
#define _HWP_PIC32_CNC_2_0_0_H_
	...
	// ENC28J60 I/O pins
		...
		#define ENC_CS_TRIS			(TRISFbits.TRISF0)
		#define ENC_CS_IO			(PORTFbits.RF0)
		//#define ENC_RST_TRIS		(TRISAbits.TRISA14)	// Not connected by default.  It is okay to leave this pin completely unconnected, in which case this macro should simply be left undefined.
		//#define ENC_RST_IO			(PORTAbits.RA14)
	#endif
		...
		#define ENC_CS_TRIS			(TRISCbits.TRISC14)
		#define ENC_CS_IO			(PORTCbits.RC14)
		#define ENC_RST_TRIS		(TRISAbits.TRISA14)	// Not connected by default.  It is okay to leave this pin completely unconnected, in which case this macro should simply be left undefined.
		#define ENC_RST_IO			(PORTAbits.RA14)
	#endif
