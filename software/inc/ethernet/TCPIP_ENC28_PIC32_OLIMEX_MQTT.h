...
#define STACK_USE_ANNOUNCE_AUTONOMOUS	5000
 ...
 */
#ifndef C_ETHERNET_HOST_NAME
	#define MY_DEFAULT_HOST_NAME			"MCHPBOARD"
#else
	#define MY_DEFAULT_HOST_NAME			C_ETHERNET_HOST_NAME
#endif
...
#define MY_DEFAULT_IP_ADDR_BYTE3        (178ul)
...
#define MY_DEFAULT_GATE_BYTE3           (178ul)
 ...
 */
	...
	#define TCP_ETH_RAM_SIZE					(4800ul)
	...
	#define TCP_SOCKET_TYPES
		...
		#define TCP_PURPOSE_MQTT_CLIENT_CLIENT 12
		#define TCP_PURPOSE_HTTP_CLIENT_CLIENT 13
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] =
		{
			...
			//{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 200, 200},
			{TCP_PURPOSE_DEFAULT, TCP_ETH_RAM, 200, 200},						//400
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 256, 256},				//912
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 256, 256},				//1424
			{TCP_PURPOSE_BERKELEY_CLIENT, TCP_ETH_RAM, 256, 256},				//1936
			{TCP_PURPOSE_BERKELEY_CLIENT, TCP_ETH_RAM, 256, 256},				//2448
			#ifdef STACK_USE_MQTT_CLIENT
				{TCP_PURPOSE_MQTT_CLIENT_CLIENT, TCP_ETH_RAM, 1024, 1024},		//4496
			#endif
			#ifdef STACK_USE_HTTP_CLIENT
			#error hmm
				{TCP_PURPOSE_HTTP_CLIENT_CLIENT, TCP_ETH_RAM, 1024, 1024},
			#endif
		};
