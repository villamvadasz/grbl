 ...
 ********************************************************************/
#ifndef _HWP_PIC32_CNC_1_0_2_H_
#define _HWP_PIC32_CNC_1_0_2_H_
	...
	// ENC28J60 I/O pins
		...
		#define ENC_RST_TRIS		(TRISDbits.TRISD3)	// Not connected by default.  It is okay to leave this pin completely unconnected, in which case this macro should simply be left undefined.
		#define ENC_RST_IO		(PORTDbits.RD3)
