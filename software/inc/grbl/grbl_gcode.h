...
// ideal, just be careful with values that state 'do not alter' and check both report.c and grbl_gcode.c 
...
#define SPINDLE_ENABLE_LASTW 0xFF
...
#define TOOL_LENGTH_OFFSET_ENABLE_DYNAMIC_NEG 2 // G44.1
...
extern void gcode_probe_update_pos(void);
