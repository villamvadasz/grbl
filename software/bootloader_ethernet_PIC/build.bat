...
:makecall_external
del /q .\output\EthernetBootloader_%CPU_TARGET%.hex
...
copy .\output\EthernetBootloader.hex .\output\EthernetBootloader_%CPU_TARGET%_Q%XTAL_TARGET%_F%SYS_TARGET%.hex
copy .\output\EthernetBootloader.map .\output\EthernetBootloader_%CPU_TARGET%_Q%XTAL_TARGET%_F%SYS_TARGET%.map
.\make\make.exe -f Makefile_%CPU_TARGET% clean
del /q .\output\EthernetBootloader.elf
del /q .\output\EthernetBootloader.hex
del /q .\output\EthernetBootloader.map
goto :eof
...
copy .\output\EthernetBootloader.hex .\output\EthernetBootloader_%CPU_TARGET%_RCINT8_F%SYS_TARGET%.hex
copy .\output\EthernetBootloader.map .\output\EthernetBootloader_%CPU_TARGET%_RCINT8_F%SYS_TARGET%.map
.\make\make.exe -f Makefile_%CPU_TARGET% clean
del /q .\output\EthernetBootloader.elf
del /q .\output\EthernetBootloader.hex
del /q .\output\EthernetBootloader.map
