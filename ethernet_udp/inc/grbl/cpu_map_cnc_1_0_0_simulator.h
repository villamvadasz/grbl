#ifndef _CPU_MAP_CNC_1_0_0_SIMULATOR_H_
#define _CPU_MAP_CNC_1_0_0_SIMULATOR_H_

	#ifdef DEFAULTS_PIC32_MX_CNC_1_0_0_SIMULATOR
		...
		#define STEP_X_DDR dummyTRIS
		#define STEP_Y_DDR dummyTRIS
		#define STEP_Z_DDR dummyTRIS
		#define STEP_X_PORT dummyLAT
		#define STEP_Y_PORT dummyLAT
		#define STEP_Z_PORT dummyLAT

		#define DIRECTION_X_DDR dummyTRIS
		#define DIRECTION_Y_DDR dummyTRIS
		#define DIRECTION_Z_DDR dummyTRIS
		#define DIRECTION_X_PORT dummyLAT
		#define DIRECTION_Y_PORT dummyLAT
		#define DIRECTION_Z_PORT dummyLAT

		#define STEPPERS_DISABLE_DDR dummyTRIS
		#define STEPPERS_DISABLE_PORT dummyLAT
		...
		#define SPINDLE_ENABLE_DDR dummyTRIS
		#define SPINDLE_ENABLE_PORT dummyLAT

		#define SPINDLE_DIRECTION_DDR dummyTRIS
		#define SPINDLE_DIRECTION_PORT dummyLAT

		#define SPINDLE_PWM_DDR dummyTRIS

		#define VARIABLE_SPINDLE_OC 2

		#define COOLANT_FLOOD_DDR dummyTRIS
		#define COOLANT_FLOOD_PORT dummyLAT
		#define COOLANT_MIST_DDR dummyTRIS
		#define COOLANT_MIST_PORT dummyLAT
