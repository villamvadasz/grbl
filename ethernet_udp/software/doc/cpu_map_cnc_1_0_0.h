#ifndef _CPU_MAP_CNC_1_0_0_H_
#define _CPU_MAP_CNC_1_0_0_H_

	#ifdef DEFAULTS_PIC32_MX_CNC_1_0_0
		...
		#define PROBE_TRIS TRISBbits.TRISB1
		#define PROBE_PIN PORTBbits.RB1
		...
		#define DEFAULT_X_MAX_TRAVEL 398.0 // mm NOTE: Must be a positive value.
		#define DEFAULT_Y_MAX_TRAVEL 294.0 // mm NOTE: Must be a positive value.
		#define DEFAULT_Z_MAX_TRAVEL 76.0 // mm NOTE: Must be a positive value.
