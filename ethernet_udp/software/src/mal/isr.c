...
#if (ISR_IPLV_USB1 == 0)
	#define ISR_IPL_USB1 IPL0AUTO
#elif (ISR_IPLV_USB1 == 1)
	#define ISR_IPL_USB1 IPL1AUTO
#elif (ISR_IPLV_USB1 == 2)
	#define ISR_IPL_USB1 IPL2AUTO
#elif (ISR_IPLV_USB1 == 3)
	#define ISR_IPL_USB1 IPL3AUTO
#elif (ISR_IPLV_USB1 == 4)
	#define ISR_IPL_USB1 IPL4AUTO
#elif (ISR_IPLV_USB1 == 5)
	#define ISR_IPL_USB1 IPL5AUTO
#elif (ISR_IPLV_USB1 == 6)
	#define ISR_IPL_USB1 IPL6AUTO
#elif (ISR_IPLV_USB1 == 7)
	#define ISR_IPL_USB1 IPL7AUTO
#else
	#error Wrong IPL configured
#endif
...
void __ISR(_USB_1_VECTOR, ISR_IPL_USB1) IntUSB1Handler(void) {
	#ifdef ISR_USE_USB1
		isr_usb();
	#endif
}
