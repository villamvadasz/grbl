...
static void mc_arc_pre(float *target, plan_line_data_t *pl_data, float *position, float *offset, float radius, uint8 axis_0, uint8 axis_1, uint8 axis_linear, uint8 is_clockwise_arc);
static uint8 mc_arc_async(float *target, plan_line_data_t *pl_data, float *position, float *offset, float radius, uint8 axis_0, uint8 axis_1, uint8 axis_linear, uint8 is_clockwise_arc);
