...
/* Function :  USBHS_EndpointFIFOLoad_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USBHS_EndpointFIFOLoad function.
*/

PLIB_TEMPLATE void USBHS_EndpointFIFOLoad_Unsupported( USBHS_MODULE_ID index , uint8_t endpoint , void * source , size_t nBytes )
{
...
/* Function :  USBHS_EndpointFIFOUnload_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USBHS_EndpointFIFOUnload function.
*/

PLIB_TEMPLATE int USBHS_EndpointFIFOUnload_Unsupported( USBHS_MODULE_ID index , uint8_t endpoint , void * dest )
{
...
/* Function :  USBHS_Endpoint0FIFOFlush_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USBHS_Endpoint0FIFOFlush function.
*/
...
/* Function :  USBHS_Endpoint0SetupPacketLoad_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USBHS_Endpoint0SetupPacketLoad function.
*/

PLIB_TEMPLATE void USBHS_Endpoint0SetupPacketLoad_Unsupported( USBHS_MODULE_ID index , void * setupPacket , uint8_t deviceAddress , uint8_t hubAddress , uint8_t hubPortAddress , USB_SPEED speed )
{
...
/* Function :  USBHS_ExistsEndpointFIFO_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USBHS_ExistsEndpointFIFO function.
*/
