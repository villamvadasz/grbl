...
/* Function :  USBHS_SoftResetEnable_Default
  ...
  Description:
    This template implements the Default variant of the PLIB_USBHS_SoftResetEnable function.
*/

PLIB_TEMPLATE void USBHS_SoftResetEnable_Default( USBHS_MODULE_ID index )
{
    /* This function enabled the soft reset bits */

    volatile uint8_t * usbBaseAddress;

    usbBaseAddress = (uint8_t *)_USBHS_BASE_ADDRESS_VREG(index);
...
/* Function :  USBHS_SoftResetDisable_Default
  ...
  Description:
    This template implements the Default variant of the PLIB_USBHS_SoftResetDisable function.
*/
