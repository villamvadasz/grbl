...
for ($d  = 0; $d < scalar( @eeprom_memory_linear ); $d++ ) {
	...
	for ($q  = 0; $q < 4; $q++ ) {
		...
		if ($byte_add eq 0x2) {
			...
			print " CRC";
		} elsif ($byte_add eq 0xD5) {
			print " CRC";
			
		} elsif ($byte_add eq 0xD9) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " eep_coord_data X: $float";
		} elsif ($byte_add eq 0xDD) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " eep_coord_data Y: $float";
		} elsif ($byte_add eq 0xE1) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			...
			my $float= unpack "f", pack "L", hex $string;
			print " eep_coord_data Y: $float";
		} elsif ($byte_add eq 0x111) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " eep_coord_data Z: $float";

		} elsif ($byte_add eq 0x115) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " eep_coord_data X: $float";
		} elsif ($byte_add eq 0x119) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " eep_coord_data Y: $float";
		} elsif ($byte_add eq 0x11D) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " eep_coord_data Z: $float";
			...
			my $float= unpack "f", pack "L", hex $string;
			print " eep_coord_data Z: $float";
		} elsif ($byte_add eq 0x14E) {
			print " CRC";
		} elsif ($byte_add eq 0x1C7) {
			print " CRC";



		} elsif ($byte_add eq 0x1CB) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " sys_position X: $string";
		} elsif ($byte_add eq 0x1CF) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " sys_position Z: $string";
		} elsif ($byte_add eq 0x1D3) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " sys_position Z: $string";
		} elsif ($byte_add eq 0x1D4) {
			print " CRC";
		} elsif ($byte_add eq 0x1E1) {
			print " CRC";


		} elsif ($byte_add eq 0x1E5) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " coord_system_eep X: $float";
		} elsif ($byte_add eq 0x1E9) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " coord_system_eep Z: $float";
		} elsif ($byte_add eq 0x1ED) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " coord_system_eep Z: $float";
		} elsif ($byte_add eq 0x1EE) {
			print " CRC";
		} elsif ($byte_add eq 0x1FB) {
			print " CRC";


		} elsif ($byte_add eq 0x1FF) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " coord_offset_eep X: $float";
		} elsif ($byte_add eq 0x203) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " coord_offset_eep Z: $float";
		} elsif ($byte_add eq 0x207) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " coord_offset_eep Z: $float";
		} elsif ($byte_add eq 0x208) {
			print " CRC";
		} elsif ($byte_add eq 0x215) {
			print " CRC";

		} elsif ($byte_add eq 0x219) {
			my $string= get_value_holder();
			#$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " grbl_running_running_minutes X: $string";
		} elsif ($byte_add eq 0x21A) {
			print " CRC";
		...
		} elsif ($byte_add eq 0x224) {
			print " CRC";
		} elsif ($byte_add eq 0x229) {
			print " CRC";

		} elsif ($byte_add eq 0x22D) {
			my $string= get_value_holder();
			#$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " grbl_running_startup_cnt X: $string";
		} elsif ($byte_add eq 0x22E) {
			print " CRC";
		} elsif ($byte_add eq 0x233) {
			print " CRC";

		} elsif ($byte_add eq 0x237) {
			my $string= get_value_holder();
			#$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " grbl_running_spindle_running_minutes X: $string";
		} elsif ($byte_add eq 0x238) {
			print " CRC";
		} elsif ($byte_add eq 0x23D) {
			print " CRC";

		} elsif ($byte_add eq 0x23E) {
			print " MAC";
		} elsif ($byte_add eq 0x23F) {
			print " MAC";
		} elsif ($byte_add eq 0x240) {
			print " MAC";
		} elsif ($byte_add eq 0x241) {
			print " MAC";
		} elsif ($byte_add eq 0x242) {
			print " MAC";
		} elsif ($byte_add eq 0x243) {
			print " MAC";
		} elsif ($byte_add eq 0x244) {
			print " CRC";
		} elsif ($byte_add eq 0x24B) {
			print " CRC";

		} elsif ($byte_add eq 0x24C) {
			print " grbl_Tool_Length_1";
		} elsif ($byte_add eq 0x24D) {
			print " grbl_Tool_Length_1";
		} elsif ($byte_add eq 0x24E) {
			print " grbl_Tool_Length_1";
		} elsif ($byte_add eq 0x24F) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " grbl_Tool_Length_1: $float mm";
		} elsif ($byte_add eq 0x250) {
			print " CRC";
		} elsif ($byte_add eq 0x255) {
			print " CRC";


		} elsif ($byte_add eq 0x256) {
			print " grbl_Tool_Length_2";
		} elsif ($byte_add eq 0x257) {
			print " grbl_Tool_Length_2";
		} elsif ($byte_add eq 0x258) {
			print " grbl_Tool_Length_2";
		} elsif ($byte_add eq 0x259) {
			my $string= get_value_holder();
			$string = sprintf("0x%X", $string);
			my $float= unpack "f", pack "L", hex $string;
			print " grbl_Tool_Length_2: $float mm";
		} elsif ($byte_add eq 0x25A) {
			print " CRC";
			...
			print " eep_coord_teached";
		} elsif ($byte_add eq 0x265) {
			print " eep_coord_teached";
		} elsif ($byte_add eq 0x266) {
			print " eep_coord_teached";
		} elsif ($byte_add eq 0x267) {
			print " eep_coord_teached";
		} elsif ($byte_add eq 0x268) {
			print " eep_coord_teached";
		} elsif ($byte_add eq 0x269) {
			print " eep_coord_teached";
		} elsif ($byte_add eq 0x26A) {
			print " CRC";
