...
static void system_exec_rt_system_alarm(void);
static void system_exec_rt_system_state(void);
static void system_exec_rt_system_override(void);
static void protocol_exec_rt_suspend_preapare(void);
