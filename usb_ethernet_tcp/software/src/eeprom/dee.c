...
unsigned int __attribute__((nomips16)) _NVMOperation(unsigned int nvmop);
	...
	void test_dee_TC1(void) {
		...
		test_debug_var = dee_page_read(0, 0);
		if (dee_page_read(0, 0) != 0x00000017) {
			test_dee_TC_result[0] = DEE_TEST_FAILED;
			return;
		}

		test_debug_var = dee_page_read(1, 0);
		if (dee_page_read(1, 0) != 0x0000001F) {
			test_dee_TC_result[0] = DEE_TEST_FAILED;
			return;
		}

		test_debug_var = dee_page_read(2, 0);
		if (dee_page_read(2, 0) != 0x0000001F) {
			test_dee_TC_result[0] = DEE_TEST_FAILED;
			return;
		}
		...
		test_debug_var = dee_page_read(0, 0);
		if (dee_page_read(0, 0) != 0x00000015) {//0101
			test_dee_TC_result[0] = DEE_TEST_FAILED;
			return;
		}

		test_debug_var = dee_page_read(1, 0);
		if (dee_page_read(1, 0) != 0x00000017) {//0111
			test_dee_TC_result[0] = DEE_TEST_FAILED;
			return;
		}

		test_debug_var = dee_page_read(2, 0);
		if (dee_page_read(2, 0) != 0x0000001F) {//1111
			test_dee_TC_result[0] = DEE_TEST_FAILED;
			return;
		}
		...
		test_debug_var = dee_page_read(0, 0);
		if (dee_page_read(0, 0) != 0x0000002F) {//1111
			test_dee_TC_result[0] = DEE_TEST_FAILED;
			return;
		}

		test_debug_var = dee_page_read(1, 0);
		if (dee_page_read(1, 0) != 0x0000002F) {//1111
			test_dee_TC_result[0] = DEE_TEST_FAILED;
			return;
		}

		test_debug_var = dee_page_read(2, 0);
		if (dee_page_read(2, 0) != 0x00000017) {//1111
			test_dee_TC_result[0] = DEE_TEST_FAILED;
			return;
		}
