...
#define CONTROL_ABORT_BIT         0  // Uno Analog Pin 0
...
#define CONTROL_MASK      ((1<<CONTROL_ABORT_BIT)|(1<<CONTROL_FEED_HOLD_BIT)|(1<<CONTROL_CYCLE_START_BIT)|(1<<CONTROL_SAFETY_DOOR_BIT))
...
extern void setDelayRunning(uint16 delay);
extern uint8 isDelayRunning(void);
